...
module MyBasicViewWithoutViewModel {

	export class ViewWithoutViewModel extends Orange.Controls.ViewBase {
		
		constructor() {

			// call Orange.Controls.ViewBase constructor with 
			// (namespace1-namespace2-viewClass [, viewmodel])
			super("MyBasicViewWithoutViewModel-ViewWithoutViewModel");
		}
