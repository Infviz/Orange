...
(function (Controls) {
    var ElementPositioner = (function (_super) {
        ...
        function ElementPositioner() {
            _super.call(this, new Orange.Controls.StringTemplateProvider('<div style="display: inline-block; position: relative;" class="element_positioner_container"></div>'));
            this._x = 0;
            this._y = 0;
    ...
    (function (MainContainer) {
        ...
        var MainContainerViewModel = (function () {
            ...
            MainContainerViewModel.prototype.init = function () {
                ...
                this.name.subscribe(function (val) { console.log(val); });
            };
...
/// <reference path="Controls/SmartInput.ts" />
